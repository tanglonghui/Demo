...
public class JsonActivity extends AppCompatActivity {
    ...
    public void onViewClicked() {
        ...
        Gson gson=new Gson();
        Log.e(Tag1,"-------------  to json  ------------------");
        Log.e(Tag1,gson.toJson(new TestGenericBean<String>("s")));
        TestGenericBean testGenericBean=gson.fromJson(gson.toJson(new TestGenericBean<String>("s")),TestGenericBean.class);
